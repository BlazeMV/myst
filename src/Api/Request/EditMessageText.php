...
class EditMessageText extends BaseRequest
{
    ...
    public function markup($markup){
        if (!$markup instanceof Keyboard && !$markup instanceof ForceReply)
            throw new \InvalidArgumentException('$markup should be an instance of either Blaze\Myst\Api\Request\Markup\Keyboard or Blaze\Myst\Api\Request\Markup\ForceReply.');
